...
const NovoLivre     = lazy(() => import('@/pages/new/Livre'))
...
const FinanceExecutiveReport = lazy(() => import('@/pages/FinanceExecutiveReport'))
...
const OrcamentoComparativo = lazy(() => import('@/pages/OrcamentoComparativo'))
        ...
        <BrowserRouter>
          ...
          <Suspense fallback={<LoadingScreen />}>
            <Routes>
              ...
              <Route
                path="/financeiro/cliente/:clientId"
                element={
                  <ProtectedRoute>
                    <FinanceClient />
                  </ProtectedRoute>
              ...
              <Route
                path="/financeiro/relatorio-executivo"
                element={
                  <ProtectedRoute>
                    <FinanceExecutiveReport />
                  </ProtectedRoute>
                }
              />
