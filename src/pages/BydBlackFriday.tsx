...
import { Save, Plus, Trash2, FileText, Eye } from "lucide-react";
...
export default function BydBlackFriday() {
  ...
  const handlePreview = () => {
    // Navigate to preview with current data
    navigate("/budget/preview", { 
      state: { data, returnPath: "/byd-black-friday" } 
    });
  };
